                    ...
                    <div class="d-flex justify-content-center">
                        <div class="p-2 text-center position-relative" style="width: 200px; height: 200px;">
                            <label for="image-upload" class="position-absolute top-0 start-0 w-100 h-100"
                                ...
                                <img id="output-avatar" src="{{ asset('assets/images/product-dummy.png') }}"
                        ...
                        <div class="col-md-12 container">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="name" name="name" type="text"
                                    value="{{ old('name') }}" placeholder="กรอกชื่อสินค้า">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="original_price" name="original_price" type="number"
                                            value="{{ old('original_price') }}" placeholder="ราคาทุน">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="price" name="price" type="number"
                                            value="{{ old('price') }}" placeholder="ราคาขาย">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="discount" name="discount" type="number"
                                            value="{{ old('discount') }}" placeholder="ส่วนลด">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="stock" name="stock" type="number"
                                    value="{{ old('stock') }}" placeholder="จำนวนสินค้า">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="weight" name="weight" type="text"
                                            value="{{ old('weight') }}" placeholder="น้ำหนัก">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="dimension" name="dimension" type="text"
                                            value="{{ old('dimension') }}" placeholder="ขนาดสินค้า">
