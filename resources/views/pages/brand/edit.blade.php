        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">แก้ไขข้อมูลแบรนด์</h4>

                    <div class="page-title-right">
                        <a href="{{ route('masters.brands.index') }}" class="btn btn-sm btn-light">
                ...
                <div class="col-md-12 container">
                    <div class="row">
                        ...
                        <div class="text-end container">
                            <a href="{{ route('masters.brands.index') }}" class="btn btn-light">กลับไปหน้ารายการ</a>
